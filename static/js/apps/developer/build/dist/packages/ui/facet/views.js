define([
    ...
    '../ac/views',
    '../collection/views',
    'text!./templates/facets.html',
    'text!./templates/facet.html',
    'text!./templates/auto_facet.html',
    'text!./templates/facet_item.html'
], function(
    $,
    _,
    core,
    ...
    var EventType = {
        OPEN: events.type.EventType.OPEN,
        CLOSE: events.type.EventType.CLOSE,
        FILTER: 'FILTER_EVENT'
    };
     ...
     */
    var FacetView = core.view.View.extend({
        ...
        open: function() {
            if(!this.isOpen()) {
                ...
                this.triggerEvent(events.type.EventType.OPEN, {
                    view: this
                });
            }
        },
        ...
        close: function() {
            if(this.isOpen()) {
                ...
                this.triggerEvent(events.type.EventType.CLOSE, {
                    view: this
                });
            }
        },
    ...
    FacetView.Factory = core.factory.buildFactory(FacetView);
    ...
    var AutoFacetView = FacetView.extend({
        ...
        onSelect: function(e, eventBody) {
            ...
            var filter = api.query.ApiQueryFilter.parse(this.model.filter());
    ...
    AutoFacetView.Factory = core.factory.buildFactory(AutoFacetView);
     ...
     */
    var FacetItemView = core.view.View.extend({
    ...
    FacetItemView.Factory = core.factory.buildFactory(FacetItemView);
    ...
    var FacetsView = collection_views.ListView.extend({
        ...
        _applyFilter: function(filter) {
            if(_.isString(filter)) {
                filter = api.query.ApiQueryFilter.parse(filter);
            }
