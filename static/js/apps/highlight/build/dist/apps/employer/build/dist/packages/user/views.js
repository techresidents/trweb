define([
    ...
    'text!./templates/application_create.html',
    'text!./templates/requisition_select.html',
     ...
     */
    var RequisitionSelectView = core.view.View.extend({
     ...
     */
    var ApplicationCreateView = core.view.View.extend({
        ...
        _createApplication: function(requisitionSelectionModel) {
            ...
            if (requisitionSelectionModel.selected()) {
                ...
                this.triggerEvent(events.CREATE_APPLICATION, eventBody);
            }
        }
    });
     ...
     *    candidateModel: {User} (required)
     */
    var UserActionsView = core.view.View.extend({
        ...
        initChildViews: function() {
            ...
            this.applicationBriefsView = new ui.collection.views.CollectionView({
                collection: this.applicationsCollection,
                viewFactory: new core.factory.Factory(ApplicationBriefView, {})
            });
        },
