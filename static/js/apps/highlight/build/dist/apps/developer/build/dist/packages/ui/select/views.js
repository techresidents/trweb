define([
    ...
    var BaseSelectView = core.view.View.extend({
        ...
        unselect: function(model, triggerEvent) {
            ...
            if(triggerEvent) {
                this.triggerEvent(events.type.EventType.UNSELECT, {
                    model: model
                });
            }
        },
        ...
        highlight: function(model, triggerEvent) {
            ...
            if(triggerEvent) {
                this.triggerEvent(events.type.EventType.HIGHLIGHT, {
                    model: model
                });
            }
        },
        ...
        unhighlight: function(triggerEvent) {
            ...
            if(triggerEvent) {
                this.triggerEvent(events.type.EventType.UNHIGHLIGHT, {
                    model: model
                });
            }
        }
    ...
    var AutoMultiSelectView = core.view.View.extend({
        ...
        initChildViews: function() {
            var context = function(view) {
                var collection = core.view.collection.map(function(model) {
                    var json = model.toJSON();
                    json.id = model.cid;
                    return json;
                }, this);
