define([
    ...
    var eventCompare = function(a, b) {
        return core.array.defaultCompare(a.offset, b.offset);
    };
    
    var SchedulerClock = core.base.Base.extend({
    ...
    var PlayerClock = core.base.Base.extend({
        initialize: function(options) {
    ...
    var Scheduler = core.base.Base.extend({
        ...
        add: function(offset, callback) {
            ...
            core.array.binaryInsert(this.events, e, eventCompare);
        },
        ...
        nextEvent: function(elapsed) {
            ...
            var index = core.array.binarySearch(this.events, target, eventCompare);
