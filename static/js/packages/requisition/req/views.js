define([
    ...
    'api',
    'lookup',
    'text!./templates/req.html',
    'text!./templates/requisition_create.html',
    'text!./templates/requisition_read.html',
    'text!./templates/requisition_edit.html',
    'text!./templates/requisition_form.html',
    'text!./templates/wishlist_edit.html',
    'text!./templates/wishlist_item_edit.html',
    'text!./templates/wishlist_item.html',
    'text!./templates/wishlist_add_item.html'
], function(
    $,
    _,
    jquery_validate,
     ...
     */
    var WishlistItemView = core.view.View.extend({
     ...
     *      model: {RequisitionTechnology} (required)
     */
    var EditWishlistItemView = core.view.View.extend({
     ...
     */
    var EditListView = core.view.View.extend({
     ...
     */
    var AddWishlistItemView = core.view.View.extend({
        ...
        _add: function(data) {
            ...
            if (technologyName) {
                ...
                if (!technologies.length && !originalTechnologies.length) {
                    var technology = new api.models.Technology({
                        id: data.id,
                        name: data.name,
     ...
     */
    var EditRequisitionWishlistView = core.view.View.extend({
     ...
     */
    var RequisitionFormView = core.view.View.extend({
     ...
     */
    var ReadRequisitionView = core.view.View.extend({
        ...
        createWishlistItemView: function(model) {
            ...
            core.array.binaryInsert(this.childViews, view, compare);
            return view;
        },
