define([
    ...
    var ApplicantHandler = core.base.Base.extend({
        ...
        makeInterviewOffer: function() {
            this.view.triggerEvent(events.SHOW_MAKE_INTERVIEW_OFFER, {
                model: this.model
            });
        },

        rescindInterviewOffer: function() {
            this.view.triggerEvent(events.SHOW_RESCIND_INTERVIEW_OFFER, {
                model: this.model
            });
        },
