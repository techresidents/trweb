...
DATABASES = {
    'default': {
        ...
        'NAME': 'integration_techresidents',                    # Or path to database file if using sqlite3.
...
TR_XD_REMOTE = 'http://integration.techresidents.com:6767/static/js/easyXDM/cors/index.html'
TR_API_ENDPOINT = 'http://integration.techresidents.com/api/v1'
TR_DIST = True
...
LOGGING = {
    ...
    'handlers': {
        ...
        'tr_web_file_handler': {
            ...
            'formatter': 'verbose',
            'filename': '/opt/tr/www/techresidents.com/integration/log/techresidents_web.integration.log',
            'when': 'midnight',
            'interval': 1,
            'backupCount': 7,
